...
#edit this path
inputfile <- "transect/MANDIFORE-SEUS-1123/pine/pecan.xml"
...
# Model analyses ----------------------------------------------------------
settings <- read.settings("/data/output/pecan_runs/transect/MANDIFORE-SEUS-1123/pine/settings_checked.xml")
