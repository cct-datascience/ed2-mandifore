...
#edit this path
inputfile <- "transect/MANDIFORE-SEUS-1872/prairie/pecan.xml"
...
# Cleanup -----------------------------------------------------------------
# Remove .h5 files --------------------------------------------------------
settings <- read.settings("/data/output/pecan_runs/transect/MANDIFORE-SEUS-1872/prairie/settings_checked.xml")
