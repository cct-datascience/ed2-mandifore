...
<https://www.ncwildlife.org/Portals/0/Conserving/documents/Piedmont/P_Oak_forest_mixed_hardwoods_pine.pdf?ver=2011-08-15-161006-140> "Usually these forests are uneven‐aged with old tress occasionally present."

Vegetation inventory data: <https://tes-sfa.ornl.gov/sites/default/files/MOFLUX_Inventory_User_Guide_20190308.pdf>

<https://www.fs.usda.gov/nrs/pubs/jrnl/2018/nrs_2018_iverson_001.pdf> Nice plot that has all the info maybe

### PFTs

-   temperate.South_Mid_Hardwood (no default ED2 PFT, but probably can use 10)
-   temperate.Southern_Pine (7)

```{r}
oak_hickory_pine <- tribble(
  ~cohort, ~dbh, ~ density,
  "mature_hardwood", 40, 0.005,
  "sapling_hardwood", 7, 0.005,
  "mature_pine", 40, 0.005,
  "sapling_pine", 7, 0.005,
)
oak_hickory_pine
```
...
Similar to above but include small percentage of  `temperate.Evergreen_Hardwood`
