...
#edit this path
inputfile <- "transect/MANDIFORE-SEUS-655/pine/pecan.xml"
...
# Model analyses ----------------------------------------------------------
settings <- read.settings("/data/output/pecan_runs/transect/MANDIFORE-SEUS-655/pine/settings_checked.xml")
