...
#edit this path
inputfile <- "transect/MANDIFORE-SEUS-352/pine/pecan.xml"
...
# Model analyses ----------------------------------------------------------
settings <- read.settings("/data/output/pecan_runs/transect/MANDIFORE-SEUS-352/pine/settings_checked.xml")
