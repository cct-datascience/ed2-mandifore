...
#edit this path
inputfile <- "transect/MANDIFORE-SEUS-1123/mixed/pecan.xml"
...
# Model analyses ----------------------------------------------------------
settings <- read.settings("/data/output/pecan_runs/transect/MANDIFORE-SEUS-1123/mixed/settings_checked.xml")
