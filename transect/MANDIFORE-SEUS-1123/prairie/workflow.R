...
#edit this path
inputfile <- "transect/MANDIFORE-SEUS-1123/prairie/pecan.xml"
...
# Model analyses ----------------------------------------------------------
settings <- read.settings("/data/output/pecan_runs/transect/MANDIFORE-SEUS-1123/prairie/settings_checked.xml")
