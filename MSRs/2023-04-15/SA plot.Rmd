...
ggplot(df, aes(x = AGB_2010, y = ecosystem, fill = ecosystem)) +
  ...
  stat_dotsinterval(aes(slab_color = ecosystem), side = "bottom", scale = 0.7) +
  scale_fill_brewer(palette = "Set2", aesthetics = c("fill", "slab_color")) +
  labs(x = "Above Ground Biomass", y = "", caption = "Distribution of median biomass of Setaria in last year of simulation across ensembles and sites") +
